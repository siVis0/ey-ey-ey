...
void FUN_141137f50(longlong *param_1,undefined8 param_2,int param_3)

{
  ...
  if (param_3 == 0) {
    ...
    local_88[6] = 0;
    local_50 = 0;
    uVar3 = FUN_141031d10(lVar2);
    FUN_141ae9150(local_c8,lVar1,uVar3);
    local_48 = &PTR_LAB_1432254f8;
  }
  else {
    if (lVar1 == 0) {
      return;
