...
void QuestSession_BuildPostQuestCmd(longlong param_1)

{
  ...
  PostQuestPayload_Init(&local_38);
  ...
  *(undefined8 *)(param_1 + 0x126ac) = local_18;
  if (*(char *)(DAT_14500ed30 + 0xae3b) == '\0') {
    QuestMgr_EnqueuePostQuestCmd(DAT_1451c46b8,(undefined8 *)(param_1 + 0x1268c),0,1);
    lVar2 = DAT_14500ed30;
